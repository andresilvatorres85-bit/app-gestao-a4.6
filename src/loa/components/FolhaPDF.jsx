...
export function FolhaHistoricoPLOA({
  filtrosTexto,
  anosResumo, anos, coresPorAno, seriePL, serieRito, serieCicloLinhas,
    ...
    <>
      ...
      <div className="pdf-pagina pdf-pagina-nova">
        ...
        <CardPDF
          ...
          sub={`Uma linha por exercício ao longo das fases — ${FASE_ROTULOS.join(' → ')}`}
          total={fmtBi(totalPeriodo)}
        >
          <GraficoLinhasFases
            fases={FASE_ROTULOS} series={serieCicloLinhas}
            formatar={fmtBi} formatarTick={fmtBiSeco} margemEixo={1e9}
